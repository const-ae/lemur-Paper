...
plot_assemble(
  ...
  add_text("Marker Genes", x = 70, y = 114.8, hjust = 0.5, vjust = 1, fontsize = font_size_small),
  add_plot(mc_biplot_marker, x = 47, y = 114.5, width = 42, height = 20),
  add_text("Diff. Gene", x = 70, y = 134.8, hjust = 0.5, vjust = 1, fontsize = font_size_small),
  add_plot(mc_biplot_diff, x = 47, y = 134.5, width = 42, height = 20),
  ...
  add_plot(de_plot_full + labs(subtitle = "Pred. DE for each cell") + theme(plot.subtitle = element_text(size = font_size_small, hjust = 0.5)) + guides(color = "none"), x = 86, y = 113.5, width = 33, height = 34),
  add_plot(de_plot_split + guides(color = "none"), x = 115, y = 112.5, width = 30, height = 35),
