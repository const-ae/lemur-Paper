...
plot_assemble(
  ...
  add_plot(cowplot::get_legend(amb_sp), x = 37, y = 3, height = 5, width = 1),
  ...
  add_plot(cowplot::get_legend(ct_sp), x = 84, y = 0.5, height = 5, width = 1),
  ...
  add_plot(cowplot::get_legend(de_sp), x = 159, y = 3, height = 5, width = 1),
