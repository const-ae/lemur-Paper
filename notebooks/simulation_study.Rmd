...
pl1 <- tibble(celltype = celltype_assign, condition = cond_assign, 
  ...
  ggplot() +
    ...
    annotate_labels_along(origin = rowMeans(Y), dir = fit$base_point, labels = "$o$: base space", at = 4, 
...
plot_assemble(
  ...
  add_plot(pl1, x = 2, y = 0, width = 65, height = 50),
  add_text("(B)", x = 1.5, y = 48, vjust = 1, fontsize = font_size, fontface = "bold"),
  add_plot(pl2, x = 1, y = 50, width = 68, height = 25),
  width = 70, height = 75, units = "mm", show_grid_lines = FALSE,
