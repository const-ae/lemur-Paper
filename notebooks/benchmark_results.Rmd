...
method_labels <-  c("PCA" = "PCA", "harmony" = "Harmony", "invertible_harmony" = "Param. Harmony",
                    "multiCondPCA" = "Rigid LEMUR", "lemur" = "LEMUR", "CPA" = "CPA", "CPA_large" = "CPA (64 dim)")
```
...
```{r}
methods <- c("PCA", "harmony", "invertible_harmony", "multiCondPCA", "lemur", "CPA", "CPA_large")
...
int_bio_df <- left_join(int_data %>%  dplyr::select(data, method, comparison, mix),
  ...
  filter(method %in% c("PCA", "harmony", "lemur", "CPA","CPA_large")) %>%
  mutate(method = factor(method, c("lemur", "PCA", "harmony", "CPA", "CPA_large"))) %>%
...
```{r}
pred_methods <- c("linear", "PCA", "harmony", "invertible_harmony", "multiCondPCA", "lemur", "CPA",  "CPA_large", "no_change")
pred_method_labels <-  c("linear" = "Linear", "PCA" = "PCA", "harmony" = "Harmony", "invertible_harmony" = "Param. Harmony",
                    "multiCondPCA" = "Rigid LEMUR", "lemur" = "LEMUR", "CPA" = "CPA", "CPA_large" = "CPA (64 dim)", "no_change" = "Identity")
...
perf_pred_plot <- pred_data_long %>%
  ...
  filter(method %in% c("no_change", "lemur", "CPA", "CPA_large")) %>%
  mutate(method = factor(method, c("lemur", "no_change", "CPA", "CPA_large"))) %>%
  ...
  ggplot(aes(x = rel_perf, y = method)) +
    ...
    scale_y_discrete(labels = c("lemur" = "LEMUR", "CPA" = "CPA", "CPA_large" = "CPA (64 dim)", "no_change" = "Identity")) +
