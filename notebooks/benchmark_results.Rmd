...
plot_assemble(
  add_plot(cowplot::plot_grid(plotlist = fdr_control_plots, ncol = 1, rel_heights = c(1,2)), x = 0, y = 0, width = 170, height = 120),
  add_plot(all_methods_power, x = 0, y = 120, width = 130, height = 80),

  
  width = 170, height = 220, units = "mm", show_grid_lines = FALSE,
